    ...
    items: [
      ...
      },
      {
        ...
        theory: [
          ...
          { id:"t7", text:"Change of variables and the Jacobian determinant", desc:"When you change coordinates (polar, cylindrical, spherical) the Jacobian |J| accounts for how areas and volumes distort under the transformation. For polar: dA = r dr dθ, not just dr dθ. In ML: normalising flows use Jacobians to track how probability density changes under a learned transformation. This is the geometric meaning of the determinant.", resource:"Thomas' Calculus — Chapter 15" },
          { id:"t8", text:"Line integrals and vector fields", desc:"A line integral ∫_C F · dr integrates a vector field along a curve — used in physics for work done by a force, in ML theory for path-dependent quantities in loss landscapes. The fundamental theorem of line integrals says: if F = ∇f (conservative field), the integral depends only on endpoints. This is why gradient fields are special.", resource:"Thomas' Calculus — Chapter 16" },
        ...
        resources: [
          { id:"r1", text:"Thomas' Calculus 14th Edition — the standard engineering textbook (book)", url:"https://www.pearson.com/en-us/subject-catalog/p/thomas-calculus/P200000006443", type:"docs" },
        ...
        extraReading: [
          { id:"e1", topic:"Kreyszig Advanced Engineering Mathematics — the complete engineering maths bible", desc:"Kreyszig covers ODEs, linear algebra, vector calculus, complex analysis, PDEs, and numerical methods in one 1200-page volume. Not for cover-to-cover reading — use as a reference when you encounter a topic in scientific ML (PDEs in physics-informed NNs, Fourier analysis in FNO) and want the full engineering treatment.", url:"https://physics.miami.edu/~nearing/mathmethods/mathematical_methods-one.pdf" },
      ...
      },
      {
        ...
        theory: [
          ...
          { id:"t7", text:"Partial differential equations — heat equation, wave equation, Laplace equation", desc:"PDEs involve partial derivatives with respect to multiple variables (usually space and time). The heat equation ∂u/∂t = α∇²u models diffusion. The wave equation ∂²u/∂t² = c²∇²u models propagation. These are the equations that neural operators (FNO, DeepONet) learn to solve. You do not need to solve arbitrary PDEs from scratch — you need enough fluency to read PDE papers.", resource:"Kreyszig — Chapter 12" },
        ],
        resources: [
          ...
          { id:"r5", text:"Kreyszig Advanced Engineering Mathematics 10th Ed — Chapters 1-6, 11-12 (book)", url:"https://physics.miami.edu/~nearing/mathmethods/mathematical_methods-one.pdf", type:"docs" },
